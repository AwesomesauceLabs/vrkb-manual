...
![VRKB animated GIF](assets/vrkb.gif "VR keyboard awesomeness")
...
<a href="assets/vrkb-on-confirm-figure.png"><image src="assets/vrkb-on-confirm-figure.png" alt="Hitting the green checkmark key triggers VRKB's 'OnConfirm' event." width="640" /></a>
...
![Keyboard Settings in the Inspector](assets/keyboard-inspector-events-closed.png)
...
![Keyboard Settings in the Inspector](assets/keyboard-inspector-events-expanded-and-highlighted.png)
...
![Selecting/Reloading the JSON Configuration File](assets/keyboard-inspector-json-options-highlighted.png)
...
<a href="assets/image-import-example-annotated.png"><image src="assets/image-import-example-annotated.png" alt="Choose 'Sprite (2D and UI) when importing images'" width="640" /></a>
